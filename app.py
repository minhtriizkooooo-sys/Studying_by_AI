...
def join(data):
    ...
    if pin != game_state['pin'] or name in game_state['player_names']: return emit('join_failed', {'msg': 'Sai PIN/Tên trùng'})
...
def handle_sub(data):
    ...
    update_lb() # Phát bảng xếp hạng ngay khi nhận đáp án
